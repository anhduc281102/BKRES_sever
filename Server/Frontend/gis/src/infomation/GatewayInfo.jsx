...
// function GatewayInfo({ gatewayAPI }) {
...
//         }
//     };
//     // Gửi yêu cầu GET đến endpoint để lấy thông tin của gateway
//     axios.get(`http://sanslab.ddns.net:5000/api/gateway/getGateway/${gatewayAPI}`,config)
//       .then(response => {
//         setGatewayInfo(response.data.data.gateway);
//       })
//       .catch(error => {
...
//           <p>Gateway Name: {gatewayInfo.gateway_name}</p>
//           <p>Gateway location: {gatewayInfo.gateway_API}</p>
//           {/* Add other gateway information here */}
//         </div>
//       )}
//     </div>
//   );
